...
async function scraper() {
    ...
    await page.goto('http://www.portaltransparencia.gov.br/servidores/consulta?orgaosServidorExercicio=OR21000&tipo=2&ordenarPor=nome&direcao=asc', { waitUntil: "domcontentloaded" });
